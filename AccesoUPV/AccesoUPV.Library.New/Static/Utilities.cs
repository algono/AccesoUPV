...
namespace AccesoUPV.Library.Static
{
    public static partial class Utilities
    {
        ...
        private static ProcessStartInfo ConnectStartInfo(string connectionName) => ProcessConnector.CreateProcessInfo(NET_CMD, ConnectWiFiCmd(connectionName));
        private static ProcessStartInfo DisconnectStartInfo => ProcessConnector.CreateProcessInfo(NET_CMD, DISCONNECT_WIFI);
